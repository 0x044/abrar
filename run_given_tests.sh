...
g++ giventests/fleetGivenTests.cpp fleet.cpp utilityFunctions.cpp dateTimeFunctions.cpp -o fleetGivenTests -lgtest -lgtest_main -pthread -std=c++11 -lsqlite3 -lssl -lcrypto
./fleetGivenTests
